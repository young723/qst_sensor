...
static void I2C_GPIO_Config(void)
{
	...
	SENSORS_I2C_GPIO_APBxClock_FUN(SENSORS_I2C_GPIO_CLK|RCC_APB2Periph_AFIO, ENABLE);
	/* PB6/PB8-I2C1_SCL、PB7/PB9-I2C1_SDA*/
#if defined(USE_I2C_1_PB8_9)
	//GPIO_PinRemapConfig(GPIO_Remap_I2C1, ENABLE);
	AFIO->MAPR |= GPIO_Remap_I2C1;
#endif
...
static  uint8_t I2C_TIMEOUT_UserCallback(void)
{
  ...
  BSP_I2C_ERROR("I2C Timeout error!"); 
