...
#define QMCX983_LOG		printf
#define QMCX983_ERR		printf
...
u8 qmcX983_WriteReg(u8 reg_add,u8 reg_dat)
{
	...
	return qst_sw_writereg(QMCX983_SLAVE_ADDRESS, reg_add, reg_dat);
#else
	return I2C_ByteWrite(QMCX983_SLAVE_ADDRESS, reg_add, reg_dat); 
#endif
}
...
{
#if defined(QST_USE_SW_I2C)
	return qst_sw_readreg(QMCX983_SLAVE_ADDRESS, reg_add, Read, num);
#else
	return I2C_BufferRead(QMCX983_SLAVE_ADDRESS, reg_add, Read, num);
#endif
}
