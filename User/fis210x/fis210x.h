...
extern void FisImu_read_xyz(float acc[3], float gyro[3], unsigned char *tim_count);
extern void FisImu_read_xyz_raw(short raw_acc_xyz[3], short raw_gyro_xyz[3], unsigned char *tim_count);
