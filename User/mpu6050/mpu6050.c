...
void MPU6050_Init(void)
{
  ...
  I2C_Bus_set_slave_addr(MPU6050_SLAVE_ADDRESS);
  for(i=0;i<1000;i++)
  {
    for(j=0;j<1000;j++)
    {
...
/**
  ...
  * @retval  
  */
#define MPU6050_OFFSET_X		0
#define MPU6050_OFFSET_Y		0
#define MPU6050_OFFSET_Z		9500
void MPU6050ReadAcc(short *accData)
{
	...
	accData[0] += MPU6050_OFFSET_X;
	accData[1] += MPU6050_OFFSET_Y;
	accData[2] += MPU6050_OFFSET_Z;
}
